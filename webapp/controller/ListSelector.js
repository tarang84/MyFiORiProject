sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("ZGIT.ZGITDEMO.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias ZGIT.ZGITDEMO.controller.ListSelector
			 */
			 ...
			 * @return {ZGIT.ZGITDEMO.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
